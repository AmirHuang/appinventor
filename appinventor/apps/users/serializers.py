...
class UserRegSerializer(serializers.ModelSerializer):
    ...
    picture_token = serializers.CharField(required=True, write_only=True, label='验证码令牌', help_text='验证码令牌',
    ...
    class Meta:
        model = User
        # 返回attrs中的这些值作为最终序列化的结果
        fields = ("username", "code", "mobile", "password", "picture_token")