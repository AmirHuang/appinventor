...
class PostCasesSerializer(serializers.ModelSerializer):
    ...
    #     category = CasesCategory.objects.get(id=category_id)
    ...
    #     print(attrs.submitter)
    #     print(attrs)
    #     attrs.category = CasesCategory.objects.filter(id=attrs.category_id)

    class Meta:
        model = Cases
        fields = ("category_id", "name", "cases_brief", "cases_desc", "cases_front_image", 'category')
